...
export default {
    ...
    methods:{
        editar(){
            axios.put("https://api.solodata.es/usuario",this.form)
            .then( data =>{
                console.log(data);
            })
        },
        ...
        eliminar(){
            ...
            axios.delete("https://api.solodata.es/usuario", { headers : enviar})
            .then( datos => {
                console.log(datos);
            this.$router.push("/dashboard");
            });
    ...
    mounted:function(){
        ...
        axios.get("https://api.solodata.es/usuario?id="+ this.form.ID_USUARIO)
        .then( datos => {
